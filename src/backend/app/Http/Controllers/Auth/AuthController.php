...
//            )->toDateTimeString()
    ...
    public function register(Request $request)
    {
        ...
        $validator = RequestValidators::userValidator($request->all(), false);
...
//        $user = $this->createUser($request);
    ...
    {
        $validator = RequestValidators::roleValidator($request->all());
...
//            ->appends(request()->query());
    ...
    {
        $validator = RequestValidators::roleUpdateValidator($request->all(), $role);
    ...
    public function rolesAddUser(Request $request, Role $role, User $user)
    {
        ...
        $validator = RequestValidators::roleAddOrRemoveUserValidator($request->all());
    ...
    {
        $validator = RequestValidators::roleDeleteValidator($request->all(), $role);
