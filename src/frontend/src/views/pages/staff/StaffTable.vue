        ...
        <div class="mb-4 md:mb-0 mr-4 ag-grid-table-actions-left">
          <vs-dropdown vs-trigger-click class="cursor-pointer">
            <div class="p-4 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
              <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ staffs.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : staffs.length }} of {{ staffs.length }}</span>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      staffs() {
        return this.$store.state.userManagement.staffs
      },
    ...
    methods: {
      ...
      fetchData() {
        this.$store.dispatch("userManagement/getAllStaffs").then(() => {
          ...
          this.$vs.notify({
            title:'Sync Update',
            text:'Staff records synced with server',
            color:'success',
            position:'top-right'})
