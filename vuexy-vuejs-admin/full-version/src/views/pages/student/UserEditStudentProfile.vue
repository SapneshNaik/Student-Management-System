...
<template>
  <div id="user-edit-student-profile">
    ...
    <div class="vx-row">
      <div class="vx-col md:w-1/2 w-full">
        ...
        <vs-input class="w-full mt-4" label="First Name" v-model="data_local.first_name" type="first_name" v-validate="'max:50|min:3|alpha'"
                  name="first_name"/>
      ...
      <div class="vx-col md:w-1/2 w-full">
        ...
        <div class="vx-col md:w-1/2 w-full">
          <vs-input class="w-full mt-4" label="Middle Name" v-model="data_local.middle_name" v-validate="'max:50|min:3|alpha'"
                    name="middle_name"/>
          <span class="text-danger text-sm"
                v-show="errors.has('middle_name')">{{ errors.first('middle_name') }}</span>
        </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        prefixes: ["Mr.", "Mrs.", "Miss", "Dr.", "Ms.", "Prof.", "Rev.", "Lady.", "Sir."]
